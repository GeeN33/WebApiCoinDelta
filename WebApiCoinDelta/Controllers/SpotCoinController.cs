...
public class SpotCoinController : Controller
{
    ...
    public SpotCoinController(IDbConnection _db)
    {
        db = _db;
    }
    ...
    {
        var sql = """
        INSERT INTO bar_coin_spot (symbol, exchange, isspot, per, datetime, open, high, low, close, delta_buy, delta_sell, index)
